...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
        .sendForm('service_znksjsh', 'template_fu3643g', form.current, {
          publicKey: 'Zis5rLxrdHE2EFE9W',
        })
  ...
  return (
    <section className="contact section" id="contact">
        ...
        <span className="section__subtitle">Contatct me</span>
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">asim8181@gmail.com</span>

                        <a href="mailto:asimsiddiqui8181@gmail.com" className="contact__button">Write me{" "}
